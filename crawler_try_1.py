...
def get_son_url(html):
    ...
    return son_url_final  # the result is the addresses of the websites that contains pictures
...
def get_all_sonurl(son_url_final, headers):
    ...
    return son_imglist  # the result is the addresses of the sub websites
...
def get_all_img(main_imglist, son_imglist, headers):
    ...
    for imgurl in son_imglist:
        with open('/Users/chenguangliu/Documents/crawlers/pics/%s.jpg' % x, 'wb') as file:
